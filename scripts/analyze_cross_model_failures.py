...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Generate Baseline v0.1 cross-model failure analysis")
    ...
    try:
        ...
        data = build_failure_matrix(baseline, benchmark=args.benchmark, mode=args.mode, strict=args.strict)
        ...
        print(f"Warnings: {len(data['warnings'])} runs skipped because results.jsonl was unavailable.")
        return 0
